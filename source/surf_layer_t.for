      ...
      use steady_mod
      implicit none
      real*8 uvs,qa,ps,cdu,hflux,Elatent,
...
!      endif
     ...
     :       ,tau,qstar)
      ...
      h=hflux
      le=Elatent
      Fv=-ust_s*tst_s-0.61*Ta*ust_s*qst_s
     ...
     :       ,tau,qstar)
         ...
         h2 = hflux
         le2 = Elatent
         Fv2 = -ust_s2*tst_s2-0.61*Ta*ust_s2*qst_s2
       else
          cdm2 = 0.
          ust_s2 = 0.
          tst_s2 = 0.
